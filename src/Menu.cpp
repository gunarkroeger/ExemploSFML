...
/* Sets */
    void Menu::setbuffer(Texture B)
    {
         buffer = B;
    }

    void Menu::setfundoraiz( Texture R)
    {
         fundoR = R;
    }

    void Menu::setfundocreditos( Texture C)
    {
         fundoC = C;
    }

    void Menu::setfundosair( Texture S)
    {
         fundoS = S;
    }

    void Menu::setcursor( Texture C)
    {
         cursor = C;
    }
